...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO BNB", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "WFjEyLGsxcrJJfZjc4YjAmTyfSD2CpDQkp")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "WFjEyLGsxcrJJfZjc4YjAmTyfSD2CpDQkp"
	account := &openwallet.AssetsAccount{Alias: "HELLO BNB", WalletID: walletID, Required: 1, Symbol: "BNB", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "WFjEyLGsxcrJJfZjc4YjAmTyfSD2CpDQkp"
	accountID := "4aZEdhA5N7nAsxHpdPkfKhDhYvGegLCaeVcXEpSeKS5X"
...
/*
	walletID := "WFjEyLGsxcrJJfZjc4YjAmTyfSD2CpDQkp"
	accountID := "6S9FBjUZtqrSGrqtbozuAHPw81gE5c2NMdrdJMMmn8qS"
	addr 2
	bnb143f9qp4xe2fsh60rdsj8wx47zcmkununuwmp4l
	bnb1xwu7nsu8x293dq364xsdh73zcnw2ekq2xptaex
	...
	accountID := "4aZEdhA5N7nAsxHpdPkfKhDhYvGegLCaeVcXEpSeKS5X"
	addr 1
	bnb1sw36367x996qlawqjf2gvrf69092ytpgk605ww
*/